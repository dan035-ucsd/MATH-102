...
\begin{enumerate}
    \item None of the distributions seem to fit a linear regression model, but there does seem to be significant association with some of the data. For example, lstat has a 0.4556 correlation coefficient with crim and nox is 0.421. \\
